...
const Contact = () => {
  ...
  return (
    <div id="contact" className="contact-form-container">
      <Parallax
        className="section-container flex-col align-center section-margin section-padding"
        blur={3}
        bgImage={images.background}
        bgImageAlt="Contact section background"
        strength={400}
      >
        <h2 className="skills-title">Contact Alexis Jiménez</h2>
        <form
          className="contact-form flex-col section-padding"
          onSubmit={handlesubmit}
          aria-label="Contact Alexis Jiménez"
        >
          ...
          <input
            ...
            id="name"
            type="text"
            placeholder="e.g. Alexis Jiménez"
          ...
          <input
            ...
            id="email"
            type="email"
            placeholder="e.g. alexis.jm29@gmail.com"
            className="contact-input"
            autoComplete="email"
            required
          />
          <label htmlFor="body" className="message-label">
            Your message
          </label>
          <textarea
            id="body"
            ...
            className="message"
            placeholder="e.g. Hi Alexis, I'd like to discuss a Shopify project..."
            autoComplete="off"
            required
          />
        ...
        <Modal
          open={show}
          sent={"Submission successful!"}
          notSent={"Submission failed."}
          success={success}
        />
      </Parallax>
    </div>
